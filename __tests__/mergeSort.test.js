...
describe('#sortListUsingMergeSort', () => {
    describe('given a list of numbers', () => {
        it('returns them sorted (asc -> desc)', () => {
            expect(sortListUsingMergeSort([7, 3, 10, 6, 4, 8, 5, 7])).toStrictEqual([3, 4, 5, 6, 7, 7, 8, 10]);
            expect(sortListUsingMergeSort([1, 2, 3, 4])).toStrictEqual([1, 2, 3, 4]);
            expect(sortListUsingMergeSort([1])).toStrictEqual([1]);
            expect(sortListUsingMergeSort([1, 1, 1, 1, 1])).toStrictEqual([1, 1, 1, 1, 1]);
        });
    });
});
