...
describe('baseConverter', () => {
    ...
    test('Returns \'Invalid input.\' when passed anything other than a string of digits 0-9 as the first argument.', () => {
        ...
        expect(baseConverter('20.0', '3.2', '5')).toBe('Invalid input.');
        expect(baseConverter('20', '3', '5')).not.toBe('Invalid input.');
    });
    test('Returns \'Invalid input: value to convert contains characters not present in the base system converting from.\' when passed a value as the first argument that contains digits not present in base system.', () => {
        expect(baseConverter('1234', '3', '5')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('136', '5', '3')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('23789', '6', '5')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('237A', '10', '5')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('23Q7A', '26', '5')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('136b', '37', '3')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
        expect(baseConverter('234p', '51', '5')).toBe('Invalid input: value to convert contains characters not present in the base system converting from.');
    });
    ...
    test('Returns correct base conversion when fromBase and toBase arguments are between 2 and 10 (inclusive).', () => {
    ...
    test('Returns correct base conversion when fromBase and toBase arguments are between 11 and 62 inclusive.', () => {
