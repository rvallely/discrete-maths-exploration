...
describe('baseConverter', () => {
    ...
    test.only('Returns \'Invalid input: number to convert contains characters not present in the base system converting from.\' when passed a number as the first argument that contains digits not present in base system.', () => {
        ...
        // expect(baseConverter('234p', '53', '5')).toBe('Invalid input: number to convert contains characters not present in the base system converting from.');
    });
    test('Returns \'Invalid input.\' when passed anything other than two numbers between 2 and 62 (inclusive), for arguments two and three.', () =>{
        ...
        expect(baseConverter(10, 3, 'str!ng')).toBe('Invalid input.');
    ...
    test('Returns correct base convertion when fromBase and toBase arguments are between 11 and 36 inclusive.', () => {
        expect(baseConverter(56, 32, 29)).toBe('5L');
        expect(baseConverter()).toBe();
    //     expect(baseConverter()).toBe();
    //     expect(baseConverter()).toBe();
    //     expect(baseConverter()).toBe();
    //     expect(baseConverter()).toBe();
